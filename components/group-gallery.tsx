...
export default function GroupGallery({ title, description, image, isFullSociety = false }: PhotoGalleryProps) {
  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-slate-900 via-blue-900/5 to-slate-900 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`${isLoaded ? "animate-slide-in-left" : ""} space-y-6`}>
            <div className="space-y-2">
              <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">
                {title}
              </h2>
          ...
          <div className={`${isLoaded ? "animate-slide-in-right" : ""} relative group`}>
            <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 via-blue-500/20 to-transparent rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
